{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/download/got/pinkie-promise",
  "_nodeVersion": "4.4.1",
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/download/got"
  ],
