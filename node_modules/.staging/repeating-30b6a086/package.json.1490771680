{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-wrapper/bin-version-check/bin-version/find-versions/meow/redent/indent-string/repeating",
  "_nodeVersion": "4.4.2",
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-wrapper/bin-version-check/bin-version/find-versions/meow/redent/indent-string"
  ],
