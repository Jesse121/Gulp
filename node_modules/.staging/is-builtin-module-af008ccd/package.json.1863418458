{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/normalize-package-data/is-builtin-module",
  "_nodeVersion": "0.12.2",
  "_npmUser": {
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/normalize-package-data"
  ],
