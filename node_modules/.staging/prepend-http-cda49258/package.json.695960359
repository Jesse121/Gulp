{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-build/download/got/url-parse-lax/prepend-http",
  "_nodeVersion": "4.4.2",
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-build/download/got/url-parse-lax"
  ],
