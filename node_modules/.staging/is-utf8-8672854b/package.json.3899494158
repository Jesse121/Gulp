{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/read-pkg-up/read-pkg/load-json-file/strip-bom/is-utf8",
  "_nodeVersion": "2.3.4",
  "_npmUser": {
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/read-pkg-up/read-pkg/load-json-file/strip-bom"
  ],
