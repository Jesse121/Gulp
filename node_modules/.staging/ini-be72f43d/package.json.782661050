{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-wrapper/download/caw/get-proxy/rc/ini",
  "_nodeVersion": "2.0.1",
  "_npmUser": {
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-wrapper/download/caw/get-proxy/rc"
  ],
