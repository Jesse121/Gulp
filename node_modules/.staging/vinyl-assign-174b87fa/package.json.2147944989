{
  ...
  "_from": "vinyl-assign@^1.0.1",
  "_id": "vinyl-assign@1.2.1",
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-wrapper/download/gulp-decompress/decompress/vinyl-assign",
  "_nodeVersion": "4.1.0",
  "_npmUser": {
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-wrapper/download/gulp-decompress/decompress"
  ],
