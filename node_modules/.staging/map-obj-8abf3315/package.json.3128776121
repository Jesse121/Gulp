{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/map-obj",
  "_nodeVersion": "0.12.2",
  "_npmUser": {
  ...
  "_requiredBy": [
    ...
    "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/camelcase-keys"
  ],
