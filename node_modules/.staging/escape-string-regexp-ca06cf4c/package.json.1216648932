{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-build/download/filenamify/trim-repeated/escape-string-regexp",
  "_nodeVersion": "4.2.6",
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-build/download/filenamify/trim-repeated"
  ],
