{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-build/download/filenamify/strip-outer/escape-string-regexp",
  "_nodeVersion": "4.2.6",
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-build/download/filenamify/strip-outer"
  ],
