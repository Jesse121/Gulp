{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/download/filenamify/filename-reserved-regex",
  "_nodeVersion": "1.0.0",
  "_npmUser": {
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/download/filenamify"
  ],
