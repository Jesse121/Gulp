{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-wrapper/bin-check/executable/meow/map-obj",
  "_nodeVersion": "0.12.2",
  "_npmUser": {
  ...
  "_requiredBy": [
    ...
    "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-wrapper/bin-check/executable/meow/camelcase-keys"
  ],
