{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/vinyl-fs/glob-stream/to-absolute-glob/extend-shallow/is-extendable",
  "_nodeVersion": "0.12.4",
  "_npmUser": {
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/vinyl-fs/glob-stream/to-absolute-glob/extend-shallow"
  ],
