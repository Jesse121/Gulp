{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-build/decompress/decompress-tar/tar-stream/end-of-stream/once",
  "_nodeVersion": "4.0.0",
  "_npmUser": {
    "email": "i@izs.me",
    "name": "isaacs"
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-build/decompress/decompress-tar/tar-stream/end-of-stream"
  ],
