{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/gulp-util/lodash.template/lodash.escape",
  "_nodeVersion": "5.5.0",
  ...
  "_requiredBy": [
    "/gulp-imagemin/gulp-util/lodash.template",
    "/gulp-imagemin/gulp-util/lodash.template/lodash.templatesettings"
  ],
