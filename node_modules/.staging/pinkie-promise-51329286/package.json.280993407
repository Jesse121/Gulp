{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/read-pkg-up/read-pkg/load-json-file/pinkie-promise",
  "_nodeVersion": "4.4.1",
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/read-pkg-up/read-pkg/load-json-file"
  ],
