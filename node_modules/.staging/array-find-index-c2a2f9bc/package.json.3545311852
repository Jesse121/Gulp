{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/loud-rejection/currently-unhandled/array-find-index",
  "_nodeVersion": "4.5.0",
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/loud-rejection/currently-unhandled"
  ],
