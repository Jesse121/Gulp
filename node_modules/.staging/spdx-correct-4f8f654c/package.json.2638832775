{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/normalize-package-data/validate-npm-package-license/spdx-correct",
  "_nodeVersion": "4.2.1",
  "_npmUser": {
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-wrapper/bin-version-check/bin-version/find-versions/meow/normalize-package-data/validate-npm-package-license"
  ],
