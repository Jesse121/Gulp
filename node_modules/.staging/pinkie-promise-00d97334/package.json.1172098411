{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-wrapper/bin-check/executable/meow/read-pkg-up/read-pkg/path-type/pinkie-promise",
  "_nodeVersion": "4.4.1",
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-wrapper/bin-check/executable/meow/read-pkg-up/read-pkg/path-type"
  ],
