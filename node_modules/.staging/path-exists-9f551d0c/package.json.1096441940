{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-wrapper/bin-version-check/bin-version/find-versions/meow/read-pkg-up/find-up/path-exists",
  "_nodeVersion": "4.2.1",
  "_npmUser": {
