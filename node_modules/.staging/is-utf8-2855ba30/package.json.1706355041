{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-wrapper/bin-check/executable/meow/read-pkg-up/read-pkg/load-json-file/strip-bom/is-utf8",
  "_nodeVersion": "2.3.4",
  "_npmUser": {
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-wrapper/bin-check/executable/meow/read-pkg-up/read-pkg/load-json-file/strip-bom"
  ],
