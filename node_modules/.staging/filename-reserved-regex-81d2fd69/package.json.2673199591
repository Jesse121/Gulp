{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-build/download/filenamify/filename-reserved-regex",
  "_nodeVersion": "1.0.0",
  "_npmUser": {
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-jpegtran/jpegtran-bin/bin-build/download/filenamify"
  ],
