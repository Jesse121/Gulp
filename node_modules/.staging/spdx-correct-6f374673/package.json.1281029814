{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/bin-check/executable/meow/normalize-package-data/validate-npm-package-license/spdx-correct",
  "_nodeVersion": "4.2.1",
  "_npmUser": {
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-optipng/optipng-bin/bin-wrapper/bin-check/executable/meow/normalize-package-data/validate-npm-package-license"
  ],
