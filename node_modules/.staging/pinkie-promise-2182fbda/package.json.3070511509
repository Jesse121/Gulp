{
  ...
  "_inCache": true,
  "_installable": true,
  "_location": "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-build/download/read-all-stream/pinkie-promise",
  "_nodeVersion": "4.4.1",
  ...
  "_requiredBy": [
    "/gulp-imagemin/imagemin/imagemin-gifsicle/gifsicle/bin-build/download/read-all-stream"
  ],
